...
<head>
    ...
    <style>
        ...
        .form-control-custom:focus + .input-icon, .form-select-custom:focus + .input-icon {
            color: #2563eb;
        }
        .btn-premium-submit {
            background: #2563eb;
...
<div class="register-container">
    ...
    <div id="globalRegAlert" class="alert d-none text-center fw-medium mb-4" role="alert" style="border-radius: 12px; font-size: 0.9rem; padding: 12px;"></div>
    ...
    <form id="ajaxRegisterForm" method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-3">
            ...
            <div class="input-group-custom">
                <input type="text" id="name" name="name" class="form-control-custom" placeholder="John Doe" required>
        ...
        <div class="mb-4">
            ...
            <div class="input-group-custom">
                <input type="password" id="password_confirmation" name="password_confirmation" class="form-control-custom" placeholder="••••••••" required autocomplete="new-password">
...
document.getElementById('ajaxRegisterForm').addEventListener('submit', function(e) {
    ...
    .then(res => {
        ...
        if (res.status === 200 && res.body.success) {
            ...
            if (errors.role) {
                ...
                roleErr.innerHTML = `<i class="fa-solid fa-circle-exclamation"></i> ${errors.role[0]}`;
                roleErr.style.display = 'flex';
            }
            if (errors.name) {
                const nameErr = document.getElementById('nameError');
                nameErr.innerHTML = `<i class="fa-solid fa-circle-exclamation"></i> ${errors.name[0]}`;
    ...
    .catch(error => {
        ...
        globalRegAlert.innerHTML = `<i class="fa-solid fa-circle-xmark me-2"></i> Connection error. Try again!`;
